...
const DICT: Record<string, Record<Lang, string>> = {
  ...
  "settings.streamInactive": { ko: "스트리밍 비활성. 활성하려면", en: "Streaming inactive. To enable:", zh: "流式未启用。启用：" },
  "settings.streamInactive2": { ko: "+ 모델 다운로드 + 로컬 모드", en: "+ download model + Local mode", zh: "+ 下载模型 + 本地模式" },
