...
const DICT: Record<string, Record<Lang, string>> = {
  ...
  "model.delete": { ko: "삭제", en: "Delete", zh: "删除" },
  "model.deleteConfirm": { ko: "모델을 디스크에서 삭제할까요? 다시 사용하려면 재다운로드가 필요해요.", en: "Delete this model from disk? You'll need to re-download it to use it again.", zh: "从磁盘删除该模型？再次使用需要重新下载。" },
  "model.deleteFailed": { ko: "삭제 실패", en: "Delete failed", zh: "删除失败" },
  ...
  "settings.modelOnDisk": { ko: "디스크 점유", en: "On disk", zh: "磁盘占用" },
