...
const DICT: Record<string, Record<Lang, string>> = {
  ...
  "settings.sttModelDesc": { ko: "한국어·다국어는 Qwen3-ASR, 영어 위주면 Parakeet/Whisper가 빠르고 정확해요. HuggingFace의 다른 mlx ASR 모델도 직접 넣을 수 있어요. (선택 후 첫 사용 시 다운로드)", en: "Qwen3-ASR for Korean/multilingual; Parakeet/Whisper are fast & accurate for English. You can also paste any mlx ASR repo from HuggingFace. (Downloads on first use)", zh: "韩语/多语用 Qwen3-ASR；英语用 Parakeet/Whisper 更快更准。也可粘贴 HuggingFace 上任意 mlx ASR 模型。（首次使用时下载）" },
