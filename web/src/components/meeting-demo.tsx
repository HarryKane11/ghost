...
const SCRIPT: Step[] = [
  ...
  },
  {
    ...
    card: {
      kind: "glossary",
      title: "DER (Diarization Error Rate)",
...
const KIND = {
  web: { icon: Globe, label: "웹 검색" },
  internal: { icon: FileText, label: "사내 지식" },
  glossary: { icon: BookOpen, label: "용어" },
} as const;
